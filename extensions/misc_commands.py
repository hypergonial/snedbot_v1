...
class MiscCommands(commands.Cog, name="Miscellaneous Commands"):
    ...
    @commands.command(
        help="Displays bot ping.",
        description="Displays the current ping of the bot in miliseconds. Takes no arguments.",
        usage="ping",
    )
    @commands.guild_only()
    ...
    @commands.command(
        hidden=True,
        help="A better way to get the ping.",
        description="Why? because yes. Displays the current ping of the bot in miliseconds. Takes no arguments.",
        usage=f"LEROY",
    )
    @commands.guild_only()
    ...
    async def embed(self, ctx, *, args):
        ...
        if args.title == None or args.desc == None:
            embed = discord.Embed(
                title="❌ " + self._("Missing required argument"),
                description=self._(
    ...
    @commands.command(
        ...
        description="Displays information about the bot. Takes no arguments.",
        usage="about",
        aliases=["info"],
    )
    @commands.guild_only()
    ...
    @commands.command(
        help="Provides you with an invite link for the bot!",
        description="Provides you with an invite link so you can add the bot to your own server!",
        usage="invite",
    )
    ...
    @commands.command(
        help="Provides a link to the support Discord.",
        description="Provides a link to the support Discord, where you can ask for help or provide feedback!",
        usage="support",
    )
    ...
    @commands.command(
        help="Provides a link to source-code.",
        description="Provides a link to the GitHub repository where the bot's source-code is hosted.",
        usage="source",
    )
    ...
    @commands.command(
        ...
        description="Provides detailed information about this server.",
        usage="serverinfo",
    )
    @commands.guild_only()
    ...
    @commands.command(
        ...
        description="Provide detailed information about your user account.",
        usage="whoami",
    )
    @commands.guild_only()
    @commands.cooldown(1, 30, type=commands.BucketType.member)
    ...
    @commands.command(
        help="Displays the amount of warnings for a user.",
        description="Displays the amount of warnings issued to a user. If user is not specified, it will default to self.",
        usage="warns [user]",
    )
    @commands.guild_only()
    ...
    @commands.group(
        brief="Repeats what you said.",
        description="Repeats the provided message, while deleting the command message.",
        usage="echo <message>",
    ...
    @echo.command(
        name="to",
        help="Repeats what you said in a different channel.",
        description="Repeats the provided message in a given channel, while deleting the command message.",
        usage="echo to <channel> <message>",
    )
    @commands.guild_only()
    @commands.check(has_mod_perms)
    @commands.bot_has_permissions(manage_messages=True)
