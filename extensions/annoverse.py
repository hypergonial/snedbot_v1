...
anno_guilds = (
    372128553031958529,  # Annoverse
    627876365223591976,  # Taka
    581296099826860033,  # Aestris
    824125748302315560,  # TW
)
...
class Annoverse(commands.Cog):
    ...
    @commands.group(
        aliases=["aw"],
        help="Retrieve wiki articles from an Anno wiki!",
        description="Retrieve wiki articles from one of the Anno wikis! Defaults to the 1800 one.\n\n**Possible wikis:**\n`1800,2205,2070,1404`",
        usage="annowiki [wiki] <search term>",
    ...
    async def anno1800(self, ctx, *, query: str = None):
        ...
        try:
            ...
            embed = discord.Embed(
                title=f"Anno 1800 Wiki: {query}",
                description=results,
                color=self.annowiki_color,
            )
