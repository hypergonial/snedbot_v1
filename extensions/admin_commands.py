...
class AdminCommands(commands.Cog, name="Admin Commands"):
    ...
    @commands.command(help="Copies a message to the current channel.", description="Copies the specified message to the specified channel. Can be used to create messages that are sent by the bot to then assign role-buttons or other interactions to it.", usage="copy <channel_ID> <message_ID>")
    @commands.guild_only()
